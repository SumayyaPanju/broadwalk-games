...
## Business Goals
**Primary goal:** Increase traffic through increased customer engagement 

To support the primary goal, Boardwalk games will need to:
* Showcase the shop service 
* Increase brand awareness 
* Provide essential information to clients 
* encourage group visits and event participation

## Client 
It will appeal to people who enjoy socialising and playing games 

**User Goals:** To enjoy socialising and playing board games

There could be different user types (also known as user personas):
* **Casual gamers** - Casual gamers and families looking for a fun and relaxed atmosphere
* **Enthusiasts** - Board game enthusiasts seeking information about game events and new releases 
* **Students** - Student gamers interested in budget-friendly entertainment options and discount 

## User Stories 

Based on business goals, client goals and user personas. The following user stories have been created with acceptance criteria and tasks
...
## Project Planning
Once goals and user stories have been identified, they need to be added to the projects 

## Wireframes
Create wireframes for Large, medium and small devices

Before finalising, review and see if it meets user goals, business goals and user stories 

## Colour pallette

Usually provided by the client 

3-4 main colours, that complement each other 
...
## Fonts
Needs to match the theme and personality of the project
